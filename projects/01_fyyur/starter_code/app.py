...
class Venue(db.Model):
    ...
    seeking_talent = db.Column(db.Boolean())  # not in post html yet
...
class Artist(db.Model):
    ...
    facebook_link = db.Column(db.String(120))
    seeking_venue = db.Column(db.Boolean())  # not in post html yet
    seeking_description = db.Column(db.String(500))  # not in post html yet
    # upcoming shows
    # past shows
...
def show_artist(artist_id):
    ...
    return render_template('pages/show_artist.html', artist=artist,genres=genres)
